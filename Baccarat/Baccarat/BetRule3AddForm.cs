...
namespace Baccarat
{
    public partial class BetRule3AddForm : Form
    {
        public void SetEditMode()
        {
            cbResult3.Enabled = false;
            cbResult2.Enabled = false;
            cbResult1.Enabled = false;
        }

        public BetRule3AddForm()
        {
            result3 = GameResult.BANKER_WIN;
            result2 = GameResult.BANKER_WIN;
            result1 = GameResult.BANKER_WIN;
            InitializeComponent();
        ...
        {
            result3 = (GameResult)cbResult3.SelectedValue;
            result2 = (GameResult)cbResult2.SelectedValue;
            result1 = (GameResult)cbResult1.SelectedValue;
        ...
        private void BetRule3AddForm_Shown(object sender, EventArgs e)
        {
            cbResult3.SelectedValue = result3;
            cbResult2.SelectedValue = result2;
            cbResult1.SelectedValue = result1;
        }
